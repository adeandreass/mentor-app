    ...
    <header className="bg-emerald-500 ">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-sm font-semibold leading-6 text-gray-50 bg-emerald-700 hover:bg-blue-700 py-3 px-6 rounded-md ">
      ...
      <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-emerald-400 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
