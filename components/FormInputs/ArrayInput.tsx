        ...
        <div className="flex items-center">
          <div className="relative w-full">
            ...
            <input
              ...
              type="text"
              id="voice-search"
              className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder={`Tambah ${itemTitle}`}
            />
          </div>
          <button
            onClick={addItem}
        ...
        {items.map((item, i) => {
          return (
            <div
              ...
              key={i}
              className="bg-slate-200 flex space-x-2 ml-1 items-center justify-center w-4 h-4 dark:bg-slate-600 px-4 py-2 rounded-lg cursor-pointer  text-gray-500 dark:text-gray-400 hover:text-gray-400"
            >
              <span>{item}</span>
              <button>
                <X className="w-4 h-4" />
